    ...
    <footer className="footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            ...
            <br />
            <em>SMARTWORK over Hardwork</em> is 🔑
          </p>
        ...
        <div className="footer-links">
          ...
          <ul>
            ...
            <li><button type="button" onClick={() => goToSection('tatvas')}>The 7 Tatvas</button></li>
            <li><button type="button" onClick={() => goToSection('services')}>Plans</button></li>
      ...
      <p className="footer-built-by">
        ...
        {BUILT_BY.linkedin ? (
          <>
            {' · '}
            <a href={BUILT_BY.linkedin} target="_blank" rel="noopener noreferrer">
              LinkedIn
            </a>
          </>
        ) : null}
